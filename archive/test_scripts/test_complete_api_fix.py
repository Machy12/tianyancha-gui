...
"""
测试修复后的tianyancha_complete_api.py中的HTML提取功能
"""
...
def test_complete_api_fix():
    """测试修复后的tianyancha_complete_api.py HTML提取功能"""
    
    print("🧪 测试修复后的tianyancha_complete_api.py HTML提取功能")
    print("=" * 60)
...
if __name__ == "__main__":
    success = test_complete_api_fix()
    
    if success:
        print(f"\n🎉 测试成功！修复后的tianyancha_complete_api.py HTML提取功能正常工作")
        print(f"现在GUI界面应该能正常显示基础信息了！")
    else:
        print(f"\n💥 测试失败！需要进一步检查")
